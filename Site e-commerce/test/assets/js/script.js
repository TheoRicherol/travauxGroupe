...
let clickImg = document.getElementById("toto");
let descriptifModalLabel = document.getElementById("descriptifModalLabel");
let desctiptifModalImg1 = document.getElementById("desctiptifModalImg1");
let desctiptifModalImg2 = document.getElementById("desctiptifModalImg2");
let desctiptifModalImg3 = document.getElementById("desctiptifModalImg3");
let descriptifModalInfos = document.getElementById("descriptifModalInfos");
let descriptifModalCategory = document.getElementById("descriptifModalCategory");
let descriptifModalPrice = document.getElementById("descriptifModalPrice");
...
descriptifModalLabel.innerHTML = consoleObj.product;
// descriptifModalImg1.src = consoleObj.pics[0];
// descriptifModalImg2.src = consoleObj.pics[1];
// descriptifModalImg3.src = consoleObj.pics[2];
descriptifModalInfos.innerHTML = consoleObj.infos;
// descriptifModalCategory.innerHTML = consoleObj.;
descriptifModalPrice.innerHTML = consoleObj.price;
}

});


let categoryConsole = document.getElementById("console");
let categoryGames = document.getElementById("games");
let categoryAccessories = document.getElementById("accessories");

let categoryAllButton = document.getElementById("categoryAllButton");
let categoryConsoleButton = document.getElementById("categoryConsoleButton");
let categoryGamesButton = document.getElementById("ategoryGamesButton");
let categoryAccessoriesButton = document.getElementById("categoryAccessoriesButton");
...
button.addEventListener("click", function (e) {
    ...
    if (button == categoryConsoleButton) {
        categoryConsole.classlist.remove("invisible");
        categoryGames.classlist.remove("invisible");
        categoryAccessories.classlist.remove("invisible");
        categoryGames.classlist.add("invisible");
        categoryAccessories.classlist.add("invisible");
    };

    if (button == categoryGamesButton) {
        categoryConsole.classlist.remove("invisible");
        categoryGames.classlist.remove("invisible");
        categoryAccessories.classlist.remove("invisible");
        categoryConsole.classlist.add("invisible");
        categoryAccessories.classlist.add("invisible");
    };

    if (button == categoryAccessoriesButton) {
        categoryConsole.classlist.remove("invisible");
        categoryGames.classlist.remove("invisible");
        categoryAccessories.classlist.remove("invisible");
        categoryConsole.classlist.add("invisible");
